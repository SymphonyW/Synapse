...
| Web 控制台 | 用户聊天视图、长期记忆管理视图、运维视图、任务列表、审批恢复、死信重放、Agent Trace 工作台 | [App.tsx](apps/web/src/App.tsx), [features/memory](apps/web/src/features/memory), [features/trace](apps/web/src/features/trace) | 已完成 |
...
9. [Agent Trace 工作台](doc/47-功能-Agent-Trace工作台.md)
