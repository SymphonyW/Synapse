...
| Web 控制台 | 用户聊天视图、长期记忆管理视图、运维视图、任务列表、事件窗口、审批恢复、死信重放、Agent 轨迹展示 | [App.tsx](apps/web/src/App.tsx), [features/memory](apps/web/src/features/memory) | 已完成 |
...
6. 切到运维视图，确认任务列表、事件窗口、取消、死信列表等面板可见。
