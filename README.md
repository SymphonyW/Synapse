...
| 工具扩展 | 支持 LocalClass provider、OpenAPI schema 发现和 MCP stdio adapter provider 接入 | [providers.py](services/ai-engine-py/app/tools/providers.py), [mcp_stdio.py](services/ai-engine-py/app/tools/mcp_stdio.py) | 部分完成 |
